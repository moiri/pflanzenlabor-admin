<form action="<?php $_SERVER['REQUEST_URI']; ?>" method="post">
    ...
    <div class="form-group">
        <label>title</label>
        <input type="text" class="form-control" name="impressions[title]" value="<?php echo $this->item_imp['title']; ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="impressions[subtitle]" value="<?php echo $this->item_imp['subtitle']; ?>">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control md" name="impressions[description]" rows="5"><?php echo $this->item_imp['description']; ?></textarea>
